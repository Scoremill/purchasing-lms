    ...
    <body>
      ...
      <div class="content">
        ...
        <p>
          ...
          comprehensive 12-module course on Purchasing Management for Residential Construction.
        </p>
        
        <div class="section">
          <div class="section-title">What to expect:</div>
          <ul>
            <li>12 comprehensive modules covering residential purchasing management</li>
        ...
        <div class="section">
          ...
          <ul>
            ...
            <li>Begin with Module 1: Importance of Managing Building Materials Well</li>
