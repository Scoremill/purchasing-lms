...
<body>
  <div class="certificate-container">
    ...
    <div class="body">
      ...
      <div class="course-name">"Purchasing Management for Residential Construction"</div>
      <p class="achievement-text">
        training program. Your dedication to mastering the essential skills and knowledge<br>
        of construction purchasing management demonstrates exceptional commitment to professional excellence.
      </p>
    </div>
