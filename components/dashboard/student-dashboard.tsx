                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        You've completed all 12 modules. Complete the short end-of-course survey to unlock your certificate.
                      </p>
                    </div>
                  </div>
                </CardHeader>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                          You've completed all 12 modules and earned your certificate
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <p className="text-gray-700">
                          You have successfully completed the <strong>"Purchasing Management for Residential Construction"</strong> training program.
                        </p>
                        {completionDate && (
