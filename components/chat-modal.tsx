  ...
  useEffect(() => {
    if (!open) {
      ...
      setMessages([
        {
          id: '1',
          text: "Hello! I'm here to help you with your purchasing management questions. How can I assist you today?",
          sender: 'bot',
          timestamp: new Date(),
        },
      ]);
      ...
      <DialogContent className="max-w-4xl w-[80vw] h-[80vh] flex flex-col p-0 gap-0">
        <DialogHeader className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Ask questions about purchasing management and get expert guidance
          </p>
        </DialogHeader>
