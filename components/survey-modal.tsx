...
const MODULE_TITLES = [
  ...
  'Module 6 – The Extraordinary Value of Data',
        ...
        {submitted ? (
          ...
          <>
            ...
            <div className="overflow-y-auto flex-1 px-6 py-6 space-y-8">
              ...
              {/* Q2 */}
              <QuestionBlock number={2} text="How meaningful did you find the content across all 12 modules in terms of providing a practical understanding of residential purchasing management?">
              ...
              {/* Q9 */}
              <QuestionBlock number={9} text="After completing these 12 modules, how confident do you feel in your ability to manage or improve purchasing operations in residential construction?">
