          ...
          <div ref={contentRef} className="flex-1 max-w-2xl opacity-0">
            <div className="text-center lg:text-left">
              ...
              <p className="text-lg text-gray-600 mb-10 leading-relaxed">
                Master purchasing management for residential construction with this intensive 12-module course. Learn material management, logistics, vendor relationships, and data-driven procurement from industry experts.
              </p>
